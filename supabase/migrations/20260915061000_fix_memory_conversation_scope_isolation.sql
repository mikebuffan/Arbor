-- Enforce exact conversation scope in semantic memory retrieval.
-- Legacy conversation-scoped rows without conversation lineage fail closed.

drop function if exists public.match_memories_v3(uuid, uuid, vector, integer);

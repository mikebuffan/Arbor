...
- Cross-thread candidate dedupe: a later independently prepared PR #211 duplicated existing green #210, and is CLOSED UNMERGED, not another release option. #210 is the single source-review candidate; its owner gate and source-only CI remain unchanged. Do not install the repo helper as a Vercel project-wide ignored-build command while the old Production Branch lacks it.
...
- [x] **Item 8 VERIFIED FOR SOURCE/CLEANUP SCOPE ONLY:** research PR #207 removed temporary stacked research CI targets; separate read-only pinned-object verification on `7179920ad35a0bc1a518631549e4af5d1f3da860` passed [run 35904677599](https://github.com/mikebuffan/Arbor/actions/runs/35904677599). Current research handoff head `1f48ff810240a655fd53d3485e4a36316857c897` records that scoped receipt. This is NOT a live worker, EFTA ingestion or publication approval.
